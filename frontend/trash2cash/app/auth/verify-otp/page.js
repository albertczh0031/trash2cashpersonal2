...
export default function OTPVerificationPage() {
  ...
  useEffect(() => {
    const fetchEmail = async () => {
      try {
        ...
        const response = await fetch("http://trash2cashpersonal.onrender.com/api/getemail/", {
          headers: {
        ...
        if (response.status === 401) {
          ...
          response = await fetch("http://trash2cashpersonal.onrender.com/api/getemail/", {
            headers: {
  ...
  const handleVerify = async () => {
    try {
      const response = await fetch("http://trash2cashpersonal.onrender.com/api/verify-otp/", {
        method: "POST",
  ...
  const resendCode = async () => {
    ...
    try {
      const res = await fetch("http://trash2cashpersonal.onrender.com/api/send-otp/", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
