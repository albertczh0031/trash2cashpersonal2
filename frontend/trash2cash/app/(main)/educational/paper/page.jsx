  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-green-200 rounded-lg p-4 flex items-center gap-4 mb-6">
        <Image src="/icons/paper.png" alt="Paper" width={40} height={40} />
      ...
      <div className="bg-white rounded-lg p-6 shadow-md grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          ...
          <ul className="list-disc pl-6 text-gray-800 space-y-1">
            <li>Office paper (white and colored)</li>
            <li>Newspapers and magazines</li>
            <li>Junk mail, envelopes (no plastic windows)</li>
          </ul>

          <h2 className="font-bold text-red-600 mt-6 mb-2">NO:</h2>
          <ul className="list-disc pl-6 text-gray-800 space-y-1">
            <li>Plastic-coated paper</li>
            <li>Tissues, paper towels</li>
            <li>Waxed paper</li>
          </ul>
        </div>

        <div>
          <h2 className="font-bold mb-2">PAPER MATERIALS</h2>
          <p className="text-sm italic mb-4">Mixed Paper Recycling</p>
