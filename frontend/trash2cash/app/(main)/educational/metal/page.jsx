  ...
  return (
    <div className="p-6">
      ...
      <div className="bg-green-200 rounded-lg p-4 flex items-center gap-4 mb-6">
        <Image src="/icons/metal.png" alt="Metal" width={40} height={40} />
        <h1 className="text-2xl font-bold">METAL</h1>
      </div>
      ...
      <div className="bg-white rounded-lg p-6 shadow-md grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <ul className="list-disc pl-6 text-gray-800 space-y-1">
            ...
            <li>Metal with plastic/rubber attachments</li>
            <li>Needles or medical waste</li>
          </ul>
        </div>

        {/* Common Items */}
        <div>
          <h2 className="font-bold mb-2">FE (IRON) AND ALUMINUM</h2>
          <p className="text-sm italic mb-4">Common recyclable metals</p>
