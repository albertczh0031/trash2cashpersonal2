...
const VOUCHER_API = 'https://trash2cashpersonal2.onrender.com/api/rewards/get-voucher-instance/';
  ...
  useEffect(() => {
    const fetchVouchers = async () => {
      ...
      try {
        ...
        try {
          const refreshRes = await fetch("https://trash2cashpersonal2.onrender.com/api/token/refresh/", {
            method: "POST",
            headers: {
